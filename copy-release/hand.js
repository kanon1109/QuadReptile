...
import {
  ...
  FilesetResolver,
  // PoseLandmarker
} from "https://unpkg.com/@mediapipe/tasks-vision@0.10.0";
...
const createHandPoseLandmarker = async () => {
  ...
  // poseLandmarker = await PoseLandmarker.createFromOptions(vision, {
    // baseOptions: {
      // modelAssetPath: `https://saw-4grge3nxc2fe9366-1258136071.tcloudbaseapp.com/hand/pose_landmarker_lite.task`,
      // delegate: "GPU"
    // },
...
async function predictWebcam() {
  ...
  try {
	...
	window.handResults = handResults; // 实时更新，每帧都会刷新
